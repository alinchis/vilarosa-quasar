...
export default {
  ...
  importantMsg: 'Vila Rosa a luat măsuri suplimentare pentru a preveni răspandirea virusului COVID-19',
  ...
  authorities: {
    ...
    ansvsa: {
      acronym: 'ANSVSA',
      title: 'Autoritatea Națională Sanitar Veterinară și pentru Siguranța Alimentelor',
    ...
    natcad: {
      acronym: 'ANT-DGCAT',
      title: 'Autoritatea Națională pentru Turism – Direcția Generală Control și Autorizare Turism',
