...
export default {
  ...
  services: {
    welcome: 'Welcome to Reception!',
    info: 'We offer 2 and 3 stars hotel rooms and 3 star restaurant services. The hotel rooms are divided in two buildings at the same site, the Breakfant is served inside the main, 2 stars hotel, building. The villa is open all year round.',
    ...
    breakfast: 'Breakfast is served from Monday to Friday between 07:00-10:30.',
  ...
  rooms2s: {
    ...
    apt: 'Apartment Triple',
    aptPrice: '180 RON',
  },

  rooms2sp: {
    title: 'Rooms 2*+',
    services: 'The rooms are opened from august 2017 and represent the most modern services we can offer, at this time. They are similar to 3* rooms, but are located at the 4th floor of the 2* building.',
    sglRoom: 'Single Room',
  ...
  rooms3s: {
    title: 'Rooms 3*',
    services: 'We offer single bed rooms (SGL), double bed rooms (DBB) and double rooms with 2 single beds (DBL). In addition to 2* rooms, they are equipped with air conditioning and phone.',
    sglRoom: 'Single Room',
    sglRoomPrice: '125 RON',
    dblRoom: 'Double Room',
    dblRoomPrice: '140 RON',
  ...
  recPriceTitle: 'Reception Normal Prices',
  roomsNoBreakfast: 'w/o Breakfast',
  ...
  managementMsg: {
    ...
    feedback: 'Please help us by offering feedback at your convenience: Reception, Facebook, TripAdvisor, Booking, Mail, or other sites. We are grateful for all feedback, even if they do not always compliment us.',
  },
